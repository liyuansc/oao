 ...
 * @author Dave Syer
 */
public class OaoUserAuthenticationConvert implements UserAuthenticationConverter {
    ...
    public Map<String, ?> convertUserAuthentication(Authentication authentication) {
        ...
        if (principal instanceof OaoUserDetails) {
            response.put(USER_ID, ((OaoUserDetails) principal).getId());
        }
        return response;
    }
